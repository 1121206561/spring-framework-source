...
public final class SqlSessionUtils {
   ...
   */
	...
	/**
	 * 通过sessionFactory.openSession(executorType)实际创建的SqlSession还是DefaultSqlSession。
	 * TransactionSynchronizationManager这个类，其内部维护了一个ThreadLocal的Map，
	 * 这里同一线程创建了SqlSession后放入ThreadLocal中，同一线程中其他Mapper接口调用方法时，
	 * 将会直接从ThreadLocal中获取。
	 */
