...
public abstract class AbstractAutoProxyCreator extends ProxyProcessorSupport
	...
	public Object postProcessAfterInitialization(@Nullable Object bean, String beanName) throws BeansException {
		...
		if (bean != null) {
			...
			/**
			 *  生成一个 beanName作为 代理类的名称 作为各种Map集合的 key
			 */
			Object cacheKey = getCacheKey(bean.getClass(), beanName);
			//是否已经进行过代理
			if (!this.earlyProxyReferences.contains(cacheKey)) {
	...
	protected Object wrapIfNecessary(Object bean, String beanName, Object cacheKey) {
		...
		/**
		 * 判断是否是一些InfrastructureClass的实现类或者是否应该跳过这个类
		 * 所谓的InfrastructureClass类就是指 Advice/PointCut/Advisor等接口的实现类
		 *  shouldSkip()默认是false 由于是protected方法，子类可以覆盖
		 */
		 ...
		 * 获取这个bean的 advice 也就是 在原方法上添加的增强方法
		 */
